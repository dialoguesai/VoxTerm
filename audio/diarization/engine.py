...
from config import (
    ...
    CONTINUITY_BONUS, CONFLICT_MARGIN, MERGE_THRESHOLD, QUALITY_RMS_THRESHOLD,
    MERGE_INTERVAL, RECLUSTER_INTERVAL, RECLUSTER_MIN_SEGMENTS, LOOP_PROB,
    WHITEN_MIN_SEGMENTS, SCD_CHANGE_THRESHOLD, SCD_WINDOW_SEC, SCD_HOP_SEC,
